...
HTML;
    ...
    public function renderExport()
    {
        ...
        if (Yii::$app->user->can('Admin') or Yii::$app->user->can('Audit.Member') or Yii::$app->user->can('Director') or Yii::$app->user->can('Director.Assistant') or Yii::$app->user->can('Sales Manager') or Yii::$app->user->can('Commercial.Director') or Yii::$app->user->can('Commercial.Manager') or Yii::$app->user->can('Customer.Director') or Yii::$app->user->can('Capturist'))
        {
