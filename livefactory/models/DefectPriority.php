...
/**
 * This is the model class for table "tbl_defect_priority".
 *
 * @property integer $id
 ...
 */
class DefectPriority extends \yii\db\ActiveRecord
{
	...
	public function getDefectPriorityIDByName($defect_priority){
