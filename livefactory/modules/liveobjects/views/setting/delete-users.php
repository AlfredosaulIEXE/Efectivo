...
$this->title = Yii::t ( 'app', 'Delete User Logins of Customers' );
...
$(document).ready(function(e) {
    $('.action').each(function(index, element) {
        var id = $(this).attr('id');
		$(this).load('index.php?r=liveobjects/setting/ajax-delete-user&id='+id);
    });
});
</script>
<div class="ibox float-e-margins">
    ...
    <div class="ibox-content">
			...
			<?php }else  echo "<h1>".Yii::t ( 'app', 'All customes  user logins Deleted already' )."</h1>";
			?>
