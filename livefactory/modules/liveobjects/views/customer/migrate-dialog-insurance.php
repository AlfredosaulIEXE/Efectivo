<div id="migrate-dialog-insurance" class="modal fade">
    <form method="post" action="index.php?r=sales/lead/migrateinsurance&id=<?=$_REQUEST['id']?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select name="insurance_id" class="form-control">
                                    ...
                                    <?php foreach ($insurances as $id => $manager): ?>
