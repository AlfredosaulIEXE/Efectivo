 ...
 * @var common\models\search\InvoiceStatus $searchModel
 */

$this->title = Yii::t('app', 'Invoice Status');
...
<?php
	if(!empty($_GET['added'])){?>
		<div class="alert alert-success"><?=Yii::t('app', 'Invoice Status is Added')?> </div>
<?php	}
?>
...
//            'modified_at', 
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['invoice/invoice-status/view','id' => $model->id,'edit'=>'t']), [
                                                    'title' => Yii::t('app', 'Edit'),
                                                  ]);},
				'defaultValue' => function ($url, $model) {
					if(\livefactory\models\DefaultValueModule::checkDefaultValue('invoice_status',$model->id)){
						return Html::a('<span class="fa fa-eraser"></span>', Yii::$app->urlManager->createUrl(['invoice/invoice-status/index','del_id' => $model->id]), [
                                                    'title' => Yii::t('app', 'Delete Default'),
                                                  ]);
					}else{
						return Html::a('<span class="fa fa-tag"></span>', Yii::$app->urlManager->createUrl(['invoice/invoice-status/index','id' => $model->id]), [
				...
				/*'delete' => function ($url, $model) {
										...
										return Html::a('<span class="glyphicon glyphicon-trash"></span>', Yii::$app->urlManager->createUrl(['invoice/invoice-status/delete','id' => $model->id]), [
