...
$(document).ready(function(e) {
	if('<?= \livefactory\models\DefaultValueModule::getDefaultValueId('lead_type')?>' != ''){
	...
	alert('Antes de crear un nuevo lead por favor revisar que no esté ya registrado.');
...
<div class="ibox float-e-margins">
	<div class="ibox-title">
		<h5><?= Html::encode($this->title) ?> <small class="m-l-sm"><?php echo Yii::t ( 'app', 'Enter Lead Details, Lead Contact Details & Address Details' ); ?></small></h5>
