...
$this->title = Yii::t ( 'app', 'Leads Papelera' );
...
<div class="row">
            ...
            echo GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($model, $key, $index, $widget) {
                            return '<a href="index.php?r=sales/lead/view-recycle&id=' . $model->id . '">' . $model->lead_name . '</a>';
                        }
                    ],
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            'delete' => function ($url, $model) {
                                ...
                                return Html::a('<span class="glyphicon glyphicon-refresh"></span>', Yii::$app->urlManager->createUrl(['sales/lead/deleted', 'id' => $model->id . $view]), [
    ...
    <input type="hidden" name="multiple_del" value="true">'.Html::a ( '<i class="glyphicon glyphicon-plus"></i> '.Yii::t ( 'app', 'Add' ), [
                            ...
                            'before' => '<form action=""  method="post" name="frm">
                                <input type="hidden" name="_csrf" value="' . $csrf . '">
   <input type="hidden" name="multiple_rec" value="true">'  . ' <a href="javascript:void(0)" onClick="all_del()" class="btn btn-info  btn-sm"><i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'Restaurar Seleccionados') . '</a>',
