...
$this->title = Yii::t ('app','Defect Attachments');
...
<div class="ibox float-e-margins">
         ...
         <div class="ibox-content">
             ...
             <div class="row">
             	...
             	<div class="col-sm-6">
             	 ...
             	 <?=Yii::t ('app','Note Attachment Type')?>: <i><?=Yii::t ('app','doc/xls/pdf/images/audio/video/zip')?></i>                
    ...
    <input type="hidden" name="_csrf" value="<?php echo $this->renderDynamic('return Yii::$app->request->csrfToken;'); ?>">
           ...
           <div class="row">
           		...
           		<button class="btn btn-primary btn-sm" value="Submit" type="submit">

					<i class="fa fa-upload"></i> <?=Yii::t ('app','Upload')?>

				</button>

				<a href="index.php?r=pmt/defect/defect-view&id=<?=$entity_id?>" class="btn btn-warning btn-sm"> <?=Yii::t ('app','Skip')?></a>
