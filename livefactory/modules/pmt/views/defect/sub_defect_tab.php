...
Pjax::begin ();
  ...
  <div class='progress-bar progress-bar-info progress-bar-striped' role='progressbar' aria-valuenow='" . $model->defect_progress . "' aria-valuemin='0' aria-valuemax='100' style='width: " . $model->defect_progress . "%'>" . $model->defect_progress . "</div>
						...
						'panel' => [ 
								...
								'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-th-list"></i> '.Yii::t('app','Sub-Defects').'   </h3>',

								'type' => 'info',

								'before'=>'<a href="javascript:void(0)" class="btn btn-success btn-sm defectScript" onClick="$(\'.defectae\').modal(\'show\');"><i class="glyphicon glyphicon-tag"></i> '.Yii::t('app','Add Subdefect').' </a>',
