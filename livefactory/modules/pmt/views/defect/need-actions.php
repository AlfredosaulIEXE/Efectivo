...
$this->title = Yii::t ( 'app', 'Pending Defects' );
							...
							$users='<div class="project-people">';
								...
								*/
								[ 
										...
										'label' => Yii::t('app', 'Project'),// 'Project',
										'filterType' => GridView::FILTER_SELECT2,
										'format' => 'raw',
										//'width' => '120px',
										'filter' => $projects,
								...
								[ 
										...
										'label' => Yii::t('app', 'Priority'),// 'Priority',
										'filterType' => GridView::FILTER_SELECT2,
										'format' => 'raw',
										//'width' => '100px',
								...
								[ 
										...
										//'width'=>'80px',
										'label' => Yii::t('app', 'Progress'),// 'Progress',
										'format' => 'raw',
										'value' => function ($model, $key, $index, $widget)
										{
