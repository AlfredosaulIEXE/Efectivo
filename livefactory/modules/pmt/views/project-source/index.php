 ...
 * @var livefactory\models\search\ProjectSource $searchModel
 */

$this->title = Yii::t('app', 'Project Sources');
...
/*function checkDefaultValue($id){
		...
		$sql="select id from tbl_default_value where entity_type='project_source' and entity_id='$id'";
...
<?php
	if(!empty($_GET['added'])){?>
		<div class="alert alert-success"><?=Yii::t('app', 'Project Source is Added')?> </div>
<?php	}
?>
<div class="project-source-index">
        ...
        'columns' => [
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['pmt/project-source/view','id' => $model->id,'edit'=>'t']), [
                                                    'title' => Yii::t('app', 'Edit'),
                                                  ]);},
				'defaultValue' => function ($url, $model) {
					if(\livefactory\models\DefaultValueModule::checkDefaultValue('project_source',$model->id)){
						return Html::a('<span class="fa fa-eraser"></span>', Yii::$app->urlManager->createUrl(['pmt/project-source/index','del_id' => $model->id]), [
                                                    'title' => Yii::t('app', 'Delete Default'),
                                                  ]);
					}else{
						return Html::a('<span class="fa fa-tag"></span>', Yii::$app->urlManager->createUrl(['pmt/project-source/index','id' => $model->id]), [
