...
if(Yii::$app->user->identity->id == $assigned_user_id || Yii::$app->params['user_role'] == 'admin'){
...
Yii::$app->request->enableCsrfValidation = true;
  ...
  //          'id',
		...
		[ 
					...
					'buttons' => [ 
...

							{
								...
								if(TaskController::getProjectOwnerId($_SESSION['project_id']) ==Yii::$app->user->identity->id){
        ...
        'panel' => [
            ...
            'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-th-list"></i> '.Yii::t('app','Task Timing').' </h3>',

            'type'=>'info',

            'before'=>'<a href="javascript:void(0)" class="btn btn-success btn-sm addTiming" onClick="$(\'.task_timing\').modal(\'show\');"><i class="glyphicon glyphicon-plus"></i>'.Yii::t('app','Add Manual Entry').'</a> '.$timeBtn,             'after'=>'<div class="total_timing" align="right">ddd</div>',
