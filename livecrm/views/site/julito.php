                                ...
                                <div id="sales">
                                    ...
                                    if($salesModel !=''){
                                        foreach($salesModel as $lead){?>
                                            <div class="search-result" style="border-bottom:1px dashed #e7eaec">
                                                <h3><a ><?= (strlen($lead['lead_name']) > 50) ? $lead['c_control']." ".substr($lead['lead_name'],0,50).'...' :$lead['c_control'] ." ".$lead['lead_name'];?></a></h3>
                                                <a  class="search-link"><?=date('F d,Y',$lead['added_at'])?></a>
                                                <?php
